...
window.LAB_I18N = {
  ja: {
    ...
    sections: {
      ...
      member: { kicker: "06 — Member", title: "主宰プロフィール" },
      access: {
        kicker: "07 — Access",
        title: "ラボへのアクセス",
      ...
      news: { kicker: "08 — News", title: "更新情報" },
      contact: {
        kicker: "09 — Contact",
        title: "共同研究・取材・進学相談",
        body:
  ...
  en: {
    ...
    sections: {
      ...
      member: { kicker: "06 — Member", title: "Principal investigator" },
      access: {
        kicker: "07 — Access",
      ...
      news: { kicker: "08 — News", title: "News" },
      contact: {
        kicker: "09 — Contact",
